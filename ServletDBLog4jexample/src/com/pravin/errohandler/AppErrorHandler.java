package com.pravin.errohandler;
...
public class AppErrorHandler extends HttpServlet {
    ...
    private void proceError(HttpServletRequest request, HttpServletResponse response) throws IOException {
